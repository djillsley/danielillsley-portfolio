...
import { Mail, Briefcase, Code, Terminal, Award, Linkedin, Download, ChartNoAxesCombined, GraduationCap, ShieldCheck, Cpu, Layers, MousePointer2, X, User } from 'lucide-react';
